...
const Post = () => {
  ...
  useEffect(() => {
    ...
    if (postDataID !== null) {
      const desirePost = getDoc(doc(db, "posts", postDataID))
        .then((data) => {
  ...
  useEffect(() => {
    let getAuthor = async () => {
      try {
        ...
        for (let postID of myAuthorData.posts) {
          // Asynchronously handle karne ke liye
          ...
          myAuthorPosts.push(
            <Cart
              ...
              para={authorPost.description}
              imgLink={authorPost.image}
              authorName={authorPost.authorDetails.fullname}
              postDate={authorPost.postDate}
            />
          );
        }
      ...
      <div className="bg-gray-100 min-h-screen flex flex-col items-center justify-center gap-[50px] p-4 md:mt-[75px] mt-[70px]">
        <div className="down max-w-3xl w-full bg-white shadow-lg rounded-2xl overflow-hidden md:mt-[30px]">
          ...
          <div className="px-6 pb-6 space-y-4 text-gray-800">
            <p>
              ...
              suscipit, urna ut tincidunt tulla facilisi. Aenean fermentum,
              felis eget ultricies gravida, mi lorem pharetra felis, ac feugiat
              velit lorem id lectus. Integer dapibus diam at neque dictum
              volutpa, consectetur adipiscing elit. Donec suscipit, urna ut
              tincidunt tincidunt, justo mi sollicitudin nisl, in commodo ligula
              lectus sit amet eli, consectetur adipiscing elit. Donec suscipit,
              urna ut tincidunt tincidunt, justo mi sollicitudin nisl, in
              commodo ligula lectus sit amet elit.ulla facilisi. Aenean
              fermentum, felis eget ultricies gravida, mi lorem pharetra felis,
              ac feugiat velit lorem id lectus. Integer dapibus diam at neque
              dictum volutpa, consectetur adipiscing elit. Donec suscipit, urna
              ut tincidunt tincidunt, justo mi sollicitudin nisl, in commodo
              ligula lectus sit amet eli, consectetur adipiscing elit. Donec
              suscipit, urna ut tincidunt tincidunt, justo mi sollicitudin nisl,
              in commodo ligula lectus sit amet elit.incidunt, justo mi
              sollicitudin nisl, in commodo ligula lectus sit amet eli,
              consectetur adipiscing elit. Donec suscipit, urna ut tincidunt
              tincidunt, justo mi sollicitudin nisl, in commodo ligula lectus
              sit amet elit
            </p>
            <p>
              {/* {postData.p3} */}
              Nulla facilisi. Aenean fermentum, feulla facilisi. Aenean
              fermentum, felis eget ultricies gravida, mi lorem pharetra felis,
              ac feugiat velit lorem id lectus. Integer dapibus diam at neque
              dictum volutpa, consectetur adipiscing elit. Donec suscipit, urna
              ut tincidunt tincidunt, justo mi sollicitudin nisl, in commodo
              ligula lectus sit amet eli, consectetur adipiscing elit. Donec
              suscipit, urna ut tincidunt tincidunt, justo mi sollicitudin nisl,
              in commodo ligula lectus sit amet elit.lis eget ultricies gravida,
              mi lorem pharetra felis, ac feugiat veto mi sollicitudin nisl, in
              commodo ligula lectus sit amet elit.
            </p>
            <p>
              {/* {postData.p4} */}
          ...
          <div className="bg-gray-200 p-6 flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-800">
                {postData !== null ? postData.authorDetails.fullname : ""}
              </h2>
              <p className="text-gray-600 text-sm">
                {postData !== null ? postData.authorDetails.dob : ""}
              </p>
              <p className="text-gray-600 text-sm">
                {postData !== null ? postData.authorDetails.email : ""}
              </p>
              <p className="text-gray-600 text-sm">
                {postData !== null ? postData.authorDetails.country : ""}
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          {postData ? (
            <div>
              <PostTagline
                postValue={`${postData.authorDetails.fullname}'s Posts`}
              />
